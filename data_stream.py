...
schema = StructType([
    ...
    StructField('originial_crime_type_name', StringType(), True),
...
def run_spark_job(spark):
    ...
    df = spark \
        ...
        .option("subscribe", "com.udacity.crime.police_event.v1") \
    ...
    agg_df = distinct_table\
             ...
             .orderBy('count(originial_crime_type_name)', ascending=False)
